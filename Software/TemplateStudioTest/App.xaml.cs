...
using TemplateStudioTest.Activation;
using TemplateStudioTest.Contracts.Services;
using TemplateStudioTest.Core.Contracts.Services;
using TemplateStudioTest.Core.Services;
using TemplateStudioTest.Helpers;
using TemplateStudioTest.Models;
using TemplateStudioTest.Notifications;
using TemplateStudioTest.Services;
using TemplateStudioTest.ViewModels;
using TemplateStudioTest.Views;

namespace TemplateStudioTest;
...
public partial class App : Application
{
    ...
    public App()
    {
        ...
        ConfigureServices((context, services) =>
        {
            ...
            services.AddTransient<LedControlViewModel>();
            services.AddTransient<LedControlPage>();
